...
- **Explorer and tab actions**: Open local HTML files directly from Explorer or an editor tab context menu.
...
6. Right-click a local `.html`, `.htm`, or `.xhtml` file in Explorer or on an editor tab and choose `Open HTML File in Integrated Browser`.
...
- **To package**:
   ```bash
    ...
    code --install-extension vsix/integrated-browser-on-activity-bar-0.0.10.vsix
   ```
